...
public class List_Q1 {
    ...
    private ArrayList<Student_ex1> students;
...
//		}
    ...
    public void printStudent() {
        for (Student_ex1 student : students) {
    ...
    public void addStudentIntoFirstStudents() {
        students.add(0, new Student_ex1("G"));
    ...
    public void addStudentIntoLastStudents() {
        students.add(students.size(), new Student_ex1("H"));
    ...
    public void addAllStudentsToStudentCopies() {
        ArrayList<Student_ex1> studentCopies = new ArrayList<>();
